...
class EMS_Admin_Menus {
    ...
    public function add_admin_menus() {
        $this->plugin->dashboard_page_hook_suffix = add_menu_page(
    ...
    public function render_employee_dashboard_page() {
        ...
        <div class="wrap ems-dashboard">
            ...
            <?php $this->user_profile_handler->show_leave_management_on_profile( $user_for_dashboard, true ); ?>
        </div>
        <style>
